...
class InvestLessonOne extends StatefulWidget{
  const InvestLessonOne({super.key});

  @override
  State<InvestLessonOne> createState() => _InvestLessonOneState();
}

class _InvestLessonOneState extends State<InvestLessonOne> {
