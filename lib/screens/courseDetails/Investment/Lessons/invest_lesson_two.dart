...
class InvestLessonTwo extends StatefulWidget{
  const InvestLessonTwo({super.key});

  @override
  State<InvestLessonTwo> createState() => _InvestLessonTwoScreenState();
}

class _InvestLessonTwoScreenState extends State<InvestLessonTwo> {
  ...
  void initState(){
    ...
    _controller = VideoPlayerController.asset('assets/videos/InvestTwoComp.mp4');
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: Text('The video explains how key financial institutions—banks, investment banks, insurance companies, and investment managers—interact within the financial ecosystem. Investment managers like Fidelity transform client funds into investment products, balancing risk and reward to generate returns. They work with investment banks for trading and earn fees from assets managed. Success in the field requires diverse skills beyond finance, with a focus on helping clients achieve sustainable financial goals'),
