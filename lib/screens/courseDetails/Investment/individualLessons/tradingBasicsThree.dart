...
class TradingBasicsThreeScreen extends StatefulWidget{
  const TradingBasicsThreeScreen({super.key});

  @override
  State<TradingBasicsThreeScreen> createState() => _TradingBasicsThreeScreenState();
}

class _TradingBasicsThreeScreenState extends State<TradingBasicsThreeScreen> {
