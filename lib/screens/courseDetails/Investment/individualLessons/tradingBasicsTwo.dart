...
class TradingBasicsTwoScreen extends StatefulWidget{
  const TradingBasicsTwoScreen({super.key});

  @override
  State<TradingBasicsTwoScreen> createState() => _TradingBasicsTwoScreenState();
}

class _TradingBasicsTwoScreenState extends State<TradingBasicsTwoScreen> {
