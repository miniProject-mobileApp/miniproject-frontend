...
class StocksLessonOne extends StatefulWidget{
  const StocksLessonOne({super.key});

  @override
  State<StocksLessonOne> createState() => _StocksLessonOneState();
}

class _StocksLessonOneState extends State<StocksLessonOne> {
  ...
  void initState(){
    ...
    _controller = VideoPlayerController.asset('assets/videos/InvestbasicsbondsComp.mp4');
