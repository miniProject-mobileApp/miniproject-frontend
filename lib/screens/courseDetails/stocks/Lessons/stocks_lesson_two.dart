...
class StocksLessonTwo extends StatefulWidget{
  const StocksLessonTwo({super.key});

  @override
  State<StocksLessonTwo> createState() => _StocksLessonTwoState();
}

class _StocksLessonTwoState extends State<StocksLessonTwo> {
