...
class StocksLessonThree extends StatefulWidget{
  const StocksLessonThree({super.key});

  @override
  State<StocksLessonThree> createState() => _StocksLessonThreeState();
}

class _StocksLessonThreeState extends State<StocksLessonThree> {
