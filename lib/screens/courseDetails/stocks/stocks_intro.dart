...
import 'package:frontend/screens/courseDetails/stocks/Lessons/stocks_lesson_one.dart';
import 'package:frontend/screens/courseDetails/stocks/Lessons/stocks_lesson_three.dart';
import 'package:frontend/screens/courseDetails/stocks/Lessons/stocks_lesson_two.dart';

class StocksIntro extends StatelessWidget{
  const StocksIntro({super.key});
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset('assets/images/stockStudy.jpeg', fit: BoxFit.cover),
                ),
              ),
            ),
                      ...
                      child: InkWell(
                        onTap: () {
                          Future.delayed(Duration(milliseconds: 200), () {
                            Navigator.push(
                            context, 
                            MaterialPageRoute(builder: (context) => StocksLessonOne())
                            );
                          });
                      ...
                      child: InkWell(
                        onTap: () {
                           Future.delayed(Duration(milliseconds: 200), () {
                            Navigator.push(
                              context, 
                              MaterialPageRoute(builder: (context) => StocksLessonTwo())
                            );
                          });
                        },
                        splashColor: const Color.fromARGB(255, 159, 206, 245),
                          ...
                          child: Row(
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Stocks lesson 2", style: TextStyle(fontSize: 16),),
                    ...
                    InkWell(
                      onTap: () {
                        Future.delayed(Duration(milliseconds: 200), () {
                            Navigator.push(
                              context, 
                              MaterialPageRoute(builder: (context) => StocksLessonThree())
                            );
                        });
                      },
                      splashColor: const Color.fromARGB(255, 159, 206, 245),
                        ...
                        child: Row(
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Stocks lesson 3", style: TextStyle(fontSize: 16),),
