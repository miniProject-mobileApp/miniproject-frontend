...
class SavingsLessonThree extends StatefulWidget{
  const SavingsLessonThree({super.key});

  @override
  State<SavingsLessonThree> createState() => _SavingsLessonThreeState();
}

class _SavingsLessonThreeState extends State<SavingsLessonThree> {
  ...
  void initState(){
    ...
    _controller = VideoPlayerController.asset('assets/videos/FinanceOneComp.mp4');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Managing your finance"),
        centerTitle: true,
