...
class SavingsLessonOne extends StatefulWidget{
  const SavingsLessonOne({super.key});

  @override
  State<SavingsLessonOne> createState() => _SavingsLessonOneState();
}

class _SavingsLessonOneState extends State<SavingsLessonOne> {
  ...
  void initState(){
    ...
    _controller = VideoPlayerController.asset('assets/videos/SevenprinciplesofinvestingComp.mp4');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("7 Investing principles"),
        centerTitle: true,
